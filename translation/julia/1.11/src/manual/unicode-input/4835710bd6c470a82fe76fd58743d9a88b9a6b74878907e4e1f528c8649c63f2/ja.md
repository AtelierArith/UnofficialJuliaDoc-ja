...
次の表は、Julia REPL（およびさまざまな他の編集環境）でLaTeXのような略語のタブ補完を介して入力できるUnicode文字を一覧にしたものです。また、REPLのヘルプにシンボルを入力することで、シンボルの入力方法に関する情報を得ることもできます。つまり、`?`を入力し、その後にREPLにシンボルを入力することで（例えば、どこかからシンボルをコピー＆ペーストすることによって）情報を得ることができます。
