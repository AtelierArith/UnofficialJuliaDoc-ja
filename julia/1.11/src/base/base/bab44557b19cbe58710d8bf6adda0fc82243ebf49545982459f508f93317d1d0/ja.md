...
`Base` と標準ライブラリの動作は、[SemVer](https://semver.org/) に定義されているように、文書化されている場合に限り安定しています。つまり、[Julia documentation](https://docs.julialang.org/) に含まれ、非安定としてマークされていない必要があります。詳細については、[API FAQ](@ref man-api) を参照してください。
